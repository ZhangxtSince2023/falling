...
export class PlatformSpawnStrategy {
    ...
    /**
     * 获取下一个平台的生成数据
     * @param {Object} difficulty - 当前难度配置 { platformWidthMin, platformWidthMax }
     * @returns {Object} { x, width }
     */
    getNextPlatform(difficulty) {
    ...
    calculateNextX(width) {
        ...
        // 7. 最终随机生成
        const nextX = Phaser.Math.Between(Math.floor(validMin), Math.floor(validMax));
